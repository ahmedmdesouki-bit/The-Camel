...
## Current suite — 517 tests green (through S11 + S11.5 integration + Dashboard v2 + founder alerts)
...
389 → 419 → 426 → 440 → 449 → 465 → 478 → 486 → 513 → 517 — are tracked in `CAMEL_CHANGELOG.md`.)*
